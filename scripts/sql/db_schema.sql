...
ALTER TABLE DIMENSION ADD CONSTRAINT "UI_DIMENSION_ID_EXT" UNIQUE (CODE);
...
ALTER TABLE DIMENSION_VALUE ADD CONSTRAINT "F_DIMENSION_ID" FOREIGN KEY(DIMENSION_ID) REFERENCES DIMENSION(ID_EXT);
ALTER TABLE DIMENSION_VALUE ADD CONSTRAINT "F_DIMENSION_PARENT_ID" FOREIGN KEY(PARENT_ID) REFERENCES DIMENSION_VALUE(ID_EXT);
...
ALTER TABLE DIMENSION_VALUE_LINK ADD CONSTRAINT "F_LINK_OWNER_ID" FOREIGN KEY(OWNER_ID) REFERENCES DIMENSION_VALUE(ID_EXT);
ALTER TABLE DIMENSION_VALUE_LINK ADD CONSTRAINT "F_LINK_DIMENSION_ID" FOREIGN KEY(DIMENSION_ID) REFERENCES DIMENSION(ID_EXT);
ALTER TABLE DIMENSION_VALUE_LINK ADD CONSTRAINT "F_LINK_VALUE_ID" FOREIGN KEY(VALUE_ID) REFERENCES DIMENSION_VALUE(ID_EXT);
...
ALTER TABLE FACT ADD CONSTRAINT "F_FACT_PARENT_ID" FOREIGN KEY(PARENT_ID) REFERENCES FACT(ID_EXT);
...
ALTER TABLE FACT_VALUE ADD CONSTRAINT "F_FACT_ID" FOREIGN KEY(FACT_ID) REFERENCES FACT(ID_EXT);
ALTER TABLE FACT_VALUE ADD CONSTRAINT "F_DIMENSION_VALUE_ID" FOREIGN KEY(DIMENSION_VALUE_ID) REFERENCES DIMENSION_VALUE(ID_EXT);